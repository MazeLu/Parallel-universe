...
{	
	...
	{
		updateNumberOfUniverses();
	}

	
	function updateNumberOfUniverses ()
	{
	...
	function updateComplexSphere(complexSphere, elapsedTime) {
		...
		let sphereGlassOuter = complexSphere.children[1];
		let particlesOuter = complexSphere.children[2];
